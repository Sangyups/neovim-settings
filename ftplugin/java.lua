...
local config = {
    ...
    settings = {
        java = {
            ...
            home = "~/Library/Java/JavaVirtualMachines/temurin-17.0.11",
            eclipse = {
            ...
            configuration = {
                ...
                runtimes = {
                    {
                        name = "JavaSE-1.8",
                        path = "~/Library/Java/JavaVirtualMachines/temurin-1.8.0_402",
                    },
                    {
                        name = "JavaSE-11",
                        path = "~/Library/Java/JavaVirtualMachines/temurin-11.0.23",
                    },
                    {
                        name = "JavaSE-17",
                        path = "~/Library/Java/JavaVirtualMachines/temurin-17.0.11",
                    },
                },
            },
            maven = {
